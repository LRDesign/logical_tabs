  ...
  describe "rendering the output" do
    ...
    describe "rendering the whole panel" do
      ...
      it "should render an outer div containing the tabs and panes" do
        @output.should have_selector('div#tabbed_panel') do |scope|
          scope.should have_selector('ul.tabs')
          scope.should have_selector('div.panes')
        end
      end
    end
    ...
    describe "rendering tabs" do
      ...
      it "should render a url" do
        @output.should have_selector("ul.tabs")
      end
      it "should render an li for each tab" do
        @output.should have_selector("ul") do |scope|
          scope.should have_selector("li##{@panel.base_id}_tp_foo_tab")
          scope.should have_selector("li##{@panel.base_id}_tp_bar_tab")
        end
      end
      it "should render the first li selected by default" do |scope|
        @output.should have_selector("li##{@panel.base_id}_tp_foo_tab.tab_selected")
        @output.should have_selector("li##{@panel.base_id}_tp_bar_tab.tab_unselected")
      end
    end
    ...
    describe "rendering the panes" do
      ...
      it "should render an outer div of class panes" do
        @output.should have_selector('div.panes')
      end
      it "should render a div for each tab" do
        @output.should have_selector('div.panes') do |scope|
          scope.should have_selector("div##{@panel.base_id}_tp_foo_pane")
          scope.should have_selector("div##{@panel.base_id}_tp_bar_pane")
        end
      end
      it "should render the first div selected by default" do
        @output.should have_selector("div##{@panel.base_id}_tp_foo_pane.pane_selected")
        @output.should have_selector("div##{@panel.base_id}_tp_bar_pane.pane_unselected")
      end
    end
  end
