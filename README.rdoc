...
Installer script coming shortly.  The documentation below this line does not work yet.

Install the basic stylesheets and javascripts:
  rails generate logical_tabs install [ --sass ] [ --jquery ]

The above command installs CSS stylesheet into public/stylesheets and a prototype version of the
javascript into public/javascripts.   Pass '--sass' to  instead copy a SASS version to public/stylesheets/sass.   Pass '--jquery' to copy the jquery javascript instead of the prototype.
...
0.8.0 (February 24, 2011)
  • Released Rails 3 gem version.
